...
// all images to be used in the app
class AppImages {

  // no avatar defaults to this dummy avatar images
  ...
  static String browser = 'assets/images/app_icons/browser.png';
  static String settings = 'assets/images/app_icons/settings.png';
  static String calculator = 'assets/images/app_icons/calculator.png';
  static String calendar = 'assets/images/app_icons/calendar.png';
  static String camera = 'assets/images/app_icons/camera.png';
  static String clock = 'assets/images/app_icons/clock.png';
  static String contact = 'assets/images/app_icons/contact.png';
